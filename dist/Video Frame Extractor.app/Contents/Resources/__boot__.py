...
_recipes_pil_prescript(['Hdf5StubImagePlugin', 'JpegImagePlugin', 'FliImagePlugin', 'GribStubImagePlugin', 'PdfImagePlugin', 'WmfImagePlugin', 'ImtImagePlugin', 'PixarImagePlugin', 'SunImagePlugin', 'SgiImagePlugin', 'IcoImagePlugin', 'FpxImagePlugin', 'XVThumbImagePlugin', 'IcnsImagePlugin', 'GifImagePlugin', 'GbrImagePlugin', 'MpoImagePlugin', 'EpsImagePlugin', 'QoiImagePlugin', 'MspImagePlugin', 'PcxImagePlugin', 'MpegImagePlugin', 'CurImagePlugin', 'XpmImagePlugin', 'BufrStubImagePlugin', 'AvifImagePlugin', 'PalmImagePlugin', 'PcdImagePlugin', 'XbmImagePlugin', 'PpmImagePlugin', 'BlpImagePlugin', 'Jpeg2KImagePlugin', 'DcxImagePlugin', 'TgaImagePlugin', 'McIdasImagePlugin', 'PngImagePlugin', 'DdsImagePlugin', 'ImImagePlugin', 'WebPImagePlugin', 'TiffImagePlugin', 'IptcImagePlugin', 'BmpImagePlugin', 'FitsImagePlugin', 'PsdImagePlugin', 'SpiderImagePlugin', 'MicImagePlugin', 'FtexImagePlugin'])
...
DEFAULT_SCRIPT='extract_last_frame.py'
SCRIPT_MAP={}
_run()
